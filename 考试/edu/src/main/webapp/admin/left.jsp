	...
	<div class="container">
		<div class="leftsidebar_box">
			...
			<dl class="channel">
				...
				<!--${path }/admin/charts/studentExamCount.jsp  -->
				<dd class="first_dd"><a href="${path}/findAllclasses?teacherId=${sessionScope.loginTeacher.teacherId}" target="right" id="12" class="handle-view">&emsp;学生考试信息&emsp;&emsp;&emsp;</a></dd>
			</dl>
			<dl class="app">
