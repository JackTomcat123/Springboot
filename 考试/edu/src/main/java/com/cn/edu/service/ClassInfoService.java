...
public class ClassInfoService{
	...
	//根据当前班级班主任编号获取当前班级信息
	public ClassInfo getClassByTeacherId(int teacherId,int classId) {
		return classInfoMapper.getClassByTeacherId(teacherId,classId);
	}
	//获取当前老师管理的所有班级
	public List<ClassInfo> getAllClassByTeacherId(int teacherId){
		return classInfoMapper.getAllClassByTeacherId(teacherId);
