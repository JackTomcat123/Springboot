...
<%@page import="com.cn.edu.service.CourseInfoService"%>
<%@page import="com.cn.edu.entity.CourseInfo"%>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="slpk" class="selectpicker" name="courseId" id="courseId" data-live-search="true">
									...
									<option value="1">大学语文一</option>
									<option value="2">大学数学二</option>
									<option value="3">大学英语一</option>
								</select>
							</div>
						</div>
						<div class="form-group">
