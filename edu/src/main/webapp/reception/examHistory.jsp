							...
							<c:forEach items="${ehps}" var="ehp">
								<div class="col-md-4">
									<div class="thumbnail">
										...
										<div class="caption">
											<h3>
												 ${ehp. examPaper.examPaperName}
											</h3>
											<p>
												题目数量: ${ehp. examPaper.subjectNum}&emsp;&emsp; 
											 	总分: ${ehp. examPaper.examPaperScore}&emsp;&emsp;
												 得分: ${ehp.examScore }&emsp;&emsp;
											</p>
											...
											<p>
									 			 <a class="btn btn-default btn-lg btn-block beginExam" href="../review?studentId=${sessionScope.loginStudent.studentId }&examPaperId=${ehp.examPaper.examPaperId }&score=${ehp.examScore }&examPaperName=${ehp.examPaper.examPaperName }">回顾试卷</a>
											</p>
										</div>
									</div>
								</div>
